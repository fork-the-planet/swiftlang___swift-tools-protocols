...
# Build swift-tools-protocols using CMake for validation purposes.
#
...
# locally it defaults to the current directory. Location-independent so this
# script can be shared/relocated without edits.
